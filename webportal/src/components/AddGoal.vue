<template>
    <section class="container">
      <form @submit.prevent="addGoal">
        ...
        <div>
          <label for="goaltext">Send</label>
          <input type="text" id="goaltext" v-model="enteredText2" />
        </div>
  ...
  export default {
    ...
    setup(_, context) {
      ...
      function addGoal() {
        ...
        context.emit("add-goal", enteredText.value,enteredText2.value);
        enteredText.value = "";
        enteredText2.value = "";
      }
